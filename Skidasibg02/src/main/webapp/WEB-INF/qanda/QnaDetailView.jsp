...
<script type="text/javascript">
		function gotoBack(){
			location.href='<%=contextPath%>/list.qa?${requestScope.parameters}';
	...
	<div class="limiter">
		<div class="panel panel-default panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title" align="left">Q&A 상세 보기</h1>
			</div>
				...
				<div class="col-sm-<%=rightside%> col-sm-<%=rightside%>">
					<table class="table table-hover table-condensed">
						<tr>
							...
							<td width="75%" align="left">${bean.qnacode}</td>
						</tr>
						<tr>
							<td width="25%" align="center">작성자</td>
							<td width="75%" align="left">${bean.member_id}</td>
						</tr>
						<tr>
							<td width="25%" align="center">제목</td>
							<td width="75%" align="left">${bean.qnatitle}
							</td>
						</tr> 
						<tr>
							<td width="25%" align="center">글 내용</td>
							<td width="75%" align="left">${bean.qnacont}</td>
						</tr>
						<tr>
							<td width="25%" align="center">조회수</td>
							<td width="75%" align="left">${bean.qnahit}</td>
						</tr>
						<tr>
							<td width="25%" align="center">작성일자</td>
							<td width="75%" align="left">${bean.qnawdate}</td>
						</tr>
					</table>
				</div>
				<hr>
