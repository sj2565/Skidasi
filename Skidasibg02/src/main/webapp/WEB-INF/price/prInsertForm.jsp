...
function checkForm() {
	var resortName = document.myform.resortName.value;
	if (resortName == '' || resortName == null) {
		alert('리조트 이름을 입력하세요.');
		return false;
	}
...
<body>
	<div class="limiter">
		...
		<form:form modelAttribute="price" id="myform" name="myform" class="form-horizontal" role="form"
					action="${apppath}/insert.pr" method="post">
					...
					<div class="form-group">
						<label for="pr_aorc"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label">구분</label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
					...
					<div class="form-group">
						<label for="pr_price"
							class="col-xs-<%=formleft%> col-lg-<%=formleft%> control-label">가격</label>
						<div class="col-xs-<%=formright%> col-lg-<%=formright%>">
							<form:input type="text" path="pr_price" id="pr_price" name="pr_price"/>
