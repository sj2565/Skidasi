...
<div class="wrapper">
	<div class="form-group">
		<div align="center" class="col-sm-offset-3 col-sm-6">
			...
			onclick="location.href='<%=contextPath%>/insert.rs'">리조트 등록</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<c:forEach var="bean" items="${requestScope.lists}">
	  <div class="item">
	    <div class="polaroid">
	    <a href="<%=contextPath%>/detailview.rs?resort_no=${bean.resort_no}">
	    	<img src="<%=uploadedFolder%>/${bean.resort_img}" alt="no image">
	      	<div class="caption">${bean.resort_name}</div>
	    </a>  
	   	</div>
	  </div>
	</c:forEach>
