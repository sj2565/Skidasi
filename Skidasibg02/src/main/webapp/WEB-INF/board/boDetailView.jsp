	...
	<div class="limiter">
		<div class="panel panel-default panel-primary">
			<div class="panel-heading">
				<h1 class="panel-title" align="left">공지사항 상세 보기</h1>
			</div>
				...
				<div class="col-sm-<%=rightside%> col-sm-<%=rightside%>">
					<table class="table table-hover table-condensed">
						<tr>
							...
							<td width="75%" align="left">${bean.noticode}</td>
						</tr>
						<tr>
							<td width="25%" align="center">제목</td>
							<td width="75%" align="left">${bean.notititle}</td>
						</tr>
						<tr>
							<td width="25%" align="center">글 내용</td>
							<td width="75%" align="left">${bean.noticont}
							</td>
						</tr> 
						<tr>
							<td width="25%" align="center">작성 일자</td>
							<td width="75%" align="left">${bean.notidate}</td>
						</tr>
					</table>
				</div>
				<hr>
